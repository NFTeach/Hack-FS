...
const Test = () => {
  ...
  useEffect(() => {
    if (!isLoading && !isFetching && data) {
      ...
      Modal.success({
        title:
          "Congrats! You address has been validated and SBT minted to your address! It should appear shortly in your wallet.",
        content: (
          <div>
            <p>
  ...
  if (error) {
    notification.error({
      message: "Error",
      description:
        "Please try again and make sure you haven't already validated and minted this SBT",
    });
    setIsMintingInProgress(false);
  }

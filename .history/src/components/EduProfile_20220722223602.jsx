...
const Profile = () => {
    ...
    useEffect(() => {
        if (!isLoading && !isFetching && data) {
            ...
            Modal.success({
                title: "Congrats! Your withdraw transaction was successful sent! The funds should appear in your wallet shortly.",
                content: (
                    <div>
                        <p>
            ...
            executeContractFunction({
                ...
                onError: () => {
                    notification.error({
                        ...
                        description: "This educator address does not have any funds left to withdraw from smart contract!"
                    })
                    setIsWithdrawInProgress(false);
                }
            })
        ...
        <div className="page">
            ...
            <div className="pfpContainer">
                ...
                <Link to="/profilesettings">
                    <div className="profileEditEdu">Edit Profile</div>
                </Link>

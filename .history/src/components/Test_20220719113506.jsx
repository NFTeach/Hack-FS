...
const Test = () => {
    ...
    const data = [
        {
            id: "0",
            question: jsonData.Question_1,
            answer: jsonData.Answer_1,
            variants: [
                jsonData.Answer_1, 
                jsonData.Question_1_False_Answer_1, 
                jsonData.Question_1_False_Answer_2, 
                jsonData.Question_1_False_Answer_3,
            ]
          },

...
const EduDash = () => {
    ...
    async function getTestsPublished() {
      try {
        ...
        for(let i = 0; i < educatorTests.length; i++) {[
          setEducatorTokenIds(educatorTests[i].attributes.tokenId)
        ]} 
  ...
  //     try {
  //       const Tests = Moralis.Object.extend("Tests");
  //       const tokenIdQuery = new Moralis.Query(Tests);
  //       tokenIdQuery.equalTo("educatorAcc", user.attributes.accounts[0]);
  //       const 
  //     }
  //   }
  // })
